...
export default function ChatSidebar() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("chat:refresh-conversations", listener);
